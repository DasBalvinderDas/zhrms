...
workforce insights, leave, compensation, burnout-risk triage, attrition/
resignation, company announcements) in a single session. Pass your own
...
DEFAULT_PROMPTS = [
    ...
    # 6. Attrition / resignation
    "Has anyone resigned recently? Who, and what's their last working day?",
